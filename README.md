...
- 🎨 **[opengl-dotnet-template](https://github.com/dcronqvist/opengl-dotnet-template)**, a template for getting started with [OpenGL](https://www.opengl.org/) and [GLFW](https://www.glfw.org/) in a dotnet environment
<!--
